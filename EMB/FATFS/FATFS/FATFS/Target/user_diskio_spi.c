...
// available at
// https://url.de.m.mimecastprotect.com/s/5tI7Cr2jW2f1mwLj9t7mWIQ?domain=elm-chan.org
//(text at
// https://url.de.m.mimecastprotect.com/s/RhOeCvQn6QU2lOMgXHXbuqi?domain=elm-chan.org)
...
static void
rcvr_spi_multi(BYTE *buff, /* Pointer to data buffer */
...
inline DRESULT
USER_SPI_read(BYTE drv,     /* Physical drive number (0) */
...
#if _USE_WRITE
inline DRESULT
USER_SPI_write(BYTE drv,         /* Physical drive number (0) */
