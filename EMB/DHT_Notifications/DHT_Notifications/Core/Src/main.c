...
void StartDefaultTask(void *argument)
{
    ...
    dhtTaskHandle = (TaskHandle_t)osThreadNew(DHTTask, NULL, &task_attr);

    task_attr.name = "Delay";
    task_attr.priority = (osPriority_t)osPriorityNormal;
    osThreadNew(DelayTask, NULL, &task_attr);

    task_attr.name = "Print";
    task_attr.priority = (osPriority_t)osPriorityNormal;
    printTaskHandle = (TaskHandle_t)osThreadNew(PrintTask, NULL, &task_attr);
